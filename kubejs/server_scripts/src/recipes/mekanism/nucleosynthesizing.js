ServerEvents.recipes(event =>{
    ...
    const recipes = [
        ...
        {
            output:'8x ae2lt:hyperdimensional_topological_lattice',
            input:'4x ae2lt:hyperdimensional_topological_lattice',
            chemical:"10x mekmm:uu_matter",
            duration:1200,
        ...
        },
        {
            ...
            chemical:"1000x mekanism:antimatter",
            duration:1200,
            id:"uu_matter"
        }
    ]
