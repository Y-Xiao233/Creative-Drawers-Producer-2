 ...
 * @param {string} path 
 */
function generateAssemblerRecipe(ctx,path){
    ...
    player.tell(Text.of(JsonIO.toPrettyString(json)).green().clickCopy(JsonIO.toPrettyString(json)).hover("Assembler Recipe(Click to Copy)"))
}